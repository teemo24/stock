...
if(isset($_GET['id']) || isset($_POST['id'])):
    ...
    $data = $db->selectWhere("categories","*","where id = ".$id)[0];
    if(empty($data)) {
...
<main>
    ...
    <div class="content">
        <div class="content-title">
            <h3>Mettre à jour du categorie N°  : <?=$data['id']?></h3>
        </div>
                ...
                <div class="row container-fluid">
                    ...
                    ?>
                            <div class="form-table col-sm-12 mt-2">
                                <div class="alert alert-success">Categorie a ete modifié avec succes !</div>
                            </div>
                    <?php 
                        else:
                    ?>
                            <div class="form-table col-sm-12 mt-2">
                                <div class="alert alert-danger">Erreur de mise à jour du Categorie !</div>
                            </div>
                    <?php 
                        endif;
                    endif;
